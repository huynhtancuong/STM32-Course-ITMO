...
MODEL                = lab4
MODULES              = coder_posix_time.c lab4.c lab4_capi.c lab4_data.c lab4_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rtmodel.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = lab4.exe
MAKEFILE             = lab4.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2023b
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2023b
START_DIR            = C:/Users/huynh/STM32CubeIDE/workspace_1.9.0/lab4_f407_2/Simulink
S_FUNCTIONS_LIB      = $(MATLAB_ROOT)\extern\lib\win64\microsoft\asynciocoder.lib $(MATLAB_ROOT)\sys\lcc64\lcc64\lib64\wsock32.lib
NUMST                = 2
NCSTATES             = 0
